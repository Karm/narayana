...
public class TransactionalDataSourceFactory implements ObjectFactory {
    ...
    public Object getObjectInstance(Object obj, Name name, Context context, Hashtable<?, ?> environment) throws Exception {
        ...
        final TransactionManager transactionManager = (TransactionManager) getReferenceObject(ref, context, "transactionManager");
        final XADataSource xaDataSource = (XADataSource) getReferenceObject(ref, context, "xaDataSource");

        final XARecoveryModule xaRecoveryModule = getXARecoveryModule();
